 ...
 * @LastEditTime: 2024-09-19 15:59:56
 */
...
export default [
  ...
  },
  {
    ...
    response: () =>
      resultSuccess({
        //         reportContentType: '10,15,210,20',
        //         title: '温州市2022年4月普查分析报表',
        ...
        //         outline:
        //           '北京通过路文正小学（小学部）本次筛查涉及6个年级，30个班级，包括学生2352人，其中，男生1212人，女生1313人。本次筛查起止时间为2019年6月5日至2019年7月5日，经核算本次漏筛12人，25人因请假、休学等原因未能参与筛查，累计完成视力和屈光筛查2350人，总筛查率为98%，视力筛查率为98%，屈光筛查率为100%。通过有效筛查标准计算，7人判定为无效筛查，最终纳入本次统计有效筛查人数2300人。经统计分析，本校现有近视学生870人，近视率为36.87%，高度近视学生57人，高度近视率为5.70%。按性别分类，男生有效筛查1200人，近视学生430人，近视率为33.33%，高度近视率为5.32%；女生有效筛查1100人，近视学生337人，近视率为33.33% ，高度近视率为3.42%。女生近视率高于男生1.21%。按年级分类，一年级至六年级近视率分别为6.66%、6.66%、6.66%、6.66%、6.66%、6.66%，年均增长率为xx%，2019年级01班近视率最低，为1.12%，2014年级02班近视率最高，为87.42%。与2019年3月的筛查结果相比，本次筛查总体近视率上升/下降xx%（xx%/xx%），男生近视率上升/下降xx%（xx%/xx%），女生近视率上升/下降xx%（xx%/xx%）。',
        //         planModeName: '计划',
        //         nounDefinition: `
        //         <p>1.近视：单眼裸眼视力＜5.0，且等效球镜＜-0.5D</p>
        // <p>2.近视率：近视人数占有效筛查人数的百分比 </p>
        // <p>3.总筛查率：完成视力和屈光筛查人数占应筛查人数百分比</p>
        // <p>4.视力筛查率：完成视力筛查人数占应筛查人数的百分比</p>
        // <p>5.屈光筛查率：完成屈光筛查人数占应筛查人数的百分比</p>
        // <p>6.低度近视：单眼视力＜5.0，且-3.0D≤等效球镜＜-0.5D</p>
        // <p>7.中度近视：单眼视力＜5.0，且-6.0D≤等效球镜＜-3.0D</p>
        // <p>8.高度近视：单眼视力＜5.0，且等效球镜＜-6.0D</p>
        // <p>9.近视足矫：符合近视标准，且双眼矫正视力≥4.9</p>
        // <p>10.近视欠矫：符合近视标准，且单眼矫正视力＜4.9</p>
        // <p>11.近视未矫：符合近视标准，且未配戴眼镜，包括框架眼镜、隐形眼镜、OK镜等</p>
        // <p>12.足矫率：足矫人数占近视人数的百分比</p>
        // <p>13.欠矫率：欠矫人数占近视人数的百分比</p>
        // <p>14.未矫率：未矫人数占近视人数的百分比</p>
        // <p>15.远视储备：10岁及以下儿童生理情况下眼屈光为远视状态，并随年龄增长向正视化转变。6岁及以下儿童，眼屈光在100-300度之间（等效球镜为1.00D-3.00D）；6-10岁儿童，眼屈光在25-300度之间（等效球镜为0.25D-3.00D）</p>
        // <p>16.远视：等效球镜＞3.0D为疑似远视，建议至医院复查</p>
        // <p>17.散光：柱镜＜-1.0D为疑似散光，建议至医院复查</p>
        // <p>18.视力不良：包括近视、远视、散光</p>
        // <p>注：普查计划应筛查人数为已导入系统的在读学生人数，抽查计划应筛查人数为已被添加至筛查任务里的学生人数</p>
        //         `
