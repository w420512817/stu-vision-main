<template>
  <div class="w-full">
    ...
    <div class="m-b-5 text-sm leading-6">
      ...
      }}女生近视率高于男生近视率{{ floatToPercent(state.detail.myopiaDiffRate) }}差异最大。
    </div>
    ...
    <div class="w-full m-t-10">
      <div class="m-b-5 text-sm leading-6">
        ...
        }}女生高度近视率高于男生高度近视率{{ floatToPercent(state.detail.highMyopiaDiffRate) }}差异最大。
      </div>
    ...
    <div class="w-full m-t-10">
      <div class="m-b-5 text-sm leading-6">{{ areaLevel == 1 ? '全省' : '全市' }}{{ state.decStr1 }}。</div>
      <LineChartReport height="250px" width="95%" :extend="myExtend2" :label-map="labelMap2" :chart-data="chartData2" />
      <p class="text-center m-t-3">{{ areaName }}分年级男女生近视率</p>
      <div class="m-b-5 text-sm leading-6">
    ...
    <div class="w-full m-t-10">
      <div class="m-b-5 text-sm leading-6">{{ areaLevel == 1 ? '全省' : '全市' }}{{ state.decStr2 }}。</div>
      <LineChartReport
        height="250px"
        width="95%"
        :extend="myExtend2"
      ...
      />
      <p class="text-center m-t-3">{{ areaName }}分年级男女高度近视率</p>
      <div class="m-b-5 text-sm leading-6">
        注：高一包含普高一年级和职高一年级，高二包含普高二年级和职高二年级，高三包含普高三年级和职高三年级；大一包含大学本科一年级和大学专科一年级，大二包含大学本科二年级和大学专科二年级，大三包含大学本科三年级和大学专科三年级。
      </div>
    </div>
