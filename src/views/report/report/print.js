...
Print.prototype = {
  ...
  dropImg: function () {
    //清除已经有的img
    var isNeedRemove = document.querySelectorAll('img.isNeedRemove');
  ...
  getHtml: function () {
    ...
    var svgs = this.dom.querySelectorAll('svg');
    var isNeedRemove = this.dom.querySelectorAll('.isNeedRemove');
    ...
    for (var k6 = 0; k6 < svgs.length; k6++) {
      var svgstr = svgs[k6].parentNode.innerHTML;
