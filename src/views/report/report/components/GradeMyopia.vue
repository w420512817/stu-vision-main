<template>
  <div class="w-full">
    ...
    <p class="text-center m-b-3">{{ areaName }}分年级{{ areaLevel == 2 || areaLevel == 1 ? '' : '男、女生' }}近视率</p>
...
import { getClassYearMyopiaInfoPro } from '@/api/report/index_province';
...
let api = areaLevel == 1 ? getClassYearMyopiaInfoPro : getClassYearMyopiaInfo;
api({
