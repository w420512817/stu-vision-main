<template>
  <div class="w-full">
    ...
    <p class="text-center m-b-3 font-bold">{{ areaName }}学校近视矫正情况</p>
    <n-table :single-line="false" class="text-center">
      <thead>
        <tr>
          <th>序号</th>
          <th>
            <div class="w-60px">学校名称</div>
          </th>
          <th>
            <div class="w-50px">学段</div>
          </th>
          <th>
            <div>足矫人数</div>
            (男/女)
...
let { planId, areaId, areaName, areaLevel } = userStore.getAreaData;
