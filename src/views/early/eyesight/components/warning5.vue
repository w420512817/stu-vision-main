<template>
  <n-form
    ref="formRef"
    :rules="visionFallRules"
    :model="formData"
    label-placement="left"
    class="b-(1px solid #ccc) h-600px"
    :show-require-mark="false"
  >
    <n-card title="视力下降预警" size="small" pl-1 pt-sm :bordered="false">
      <n-grid cols="5" pt-lg>
        <n-form-item-gi label="筛查视力：" path="symbol">
        ...
        <n-form-item-gi ml-lg> 行 </n-form-item-gi>
      </n-grid>
...
import { operate, visionFallRules } from '@/views/early/table.data';
