<template>
  ...
  >
    <n-card title="近视风险预警" size="small" pl-1 pt-sm :bordered="false">
      <n-grid cols="5" pt-lg>
        <n-form-item-gi label="AL/CR：" path="symbol">
      ...
      <n-button type="primary" class="mt-10 ml-17 w-75px" @click="save">保存</n-button>
...
import { operate, rules } from '@/views/early/table.data';
